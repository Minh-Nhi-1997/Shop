...
if ($types) {
    // bind dynamic params + ii for limit/offset
    $bindTypes = $types . 'ii';
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-end">
                    <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#items-<?= $o['order_id']; ?>">Xem</button>
                    <a href="order-invoice.php?order_id=<?= $o['order_id']; ?>" class="btn btn-sm btn-primary">In</a>
                    <a href="admin-orders.php?delete_id=<?= $o['order_id']; ?>" class="btn btn-sm btn-danger delete-link">Xóa</a>
                  </td>
                </tr>
...
document.querySelectorAll('.delete-link').forEach(function(el){
  el.addEventListener('click', function(e){
    if(!confirm('Bạn có chắc muốn xóa đơn hàng này?')) e.preventDefault();
  });
});
</script>
</body>
</html>
```// filepath: /Applications/XAMPP/xamppfiles/htdocs/Shop/admin/page/admin-orders.php